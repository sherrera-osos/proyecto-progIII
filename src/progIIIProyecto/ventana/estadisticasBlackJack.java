...
public class estadisticasBlackJack extends JFrame{

	private static final long serialVersionUID = 1L;
	 private JTable tablaEstadisticas;
	    private ArrayList<Puntaje> listaPuntajes;
		
		public estadisticasBlackJack(JFrame previo, Usuario usuario) {
	        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
	        setMinimumSize(new Dimension(1200, 400));
	        setTitle("Ranking Global BlackJack");
	        setLocationRelativeTo(previo);

	        // 1. Obtener datos de la BD para el juego "BlackJack"
	        GestorBD gestorBD = new GestorBD();
	        listaPuntajes = gestorBD.bajarPuntajesDeJuego("BlackJack");
		...
		public void initTables() {
	        // Modelo de tabla
			ModeloEstadisticasBlackJack modelo = new ModeloEstadisticasBlackJack (listaPuntajes);	
